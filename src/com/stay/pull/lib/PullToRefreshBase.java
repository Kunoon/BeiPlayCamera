...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	static final int PULL_TO_REFRESH = 0x0;	// ��ˢ��
	static final int RELEASE_TO_REFRESH = 0x1;	// �ͷ���ˢ��
	static final int REFRESHING = 0x2;	// ��ˢ��
	static final int MANUAL_REFRESHING = 0x3;	// �ֶ���ˢ��

	public static final int MODE_PULL_DOWN_TO_REFRESH = 0x1;	// ����ˢ��ģʽ
	public static final int MODE_PULL_UP_TO_REFRESH = 0x2;	// ����ˢ��ģʽ
	public static final int MODE_BOTH = 0x3;	// ��������ͬʱ����
